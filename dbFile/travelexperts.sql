...
-- Date: July 31,2019
-- Version: 2.5
-- Functionality: Updated Database for Use to populate the website.
...
CREATE TABLE `agencies` (
  ...
  `AgncyName` varchar(100) DEFAULT NULL,
...
INSERT INTO `agents` (`AgentId`, `AgtFirstName`, `AgtMiddleInitial`, `AgtLastName`, `AgtBusPhone`, `AgtEmail`, `AgtPosition`, `AgencyId`, `Rating`, `Description`, `Title`, `Image`, `AgtMessage`, `Username`, `Password`) VALUES

(1, 'Albert', NULL, 'Einstein', '(403) 210-7833', 'albert.einstein@travelexperts.com', 'Intermediate Agent', 2, 5,'"Imagination is more important than knowledge. Knowledge is limited. Imagination encircles the world."', 'The Father of Modern Physics', 'images/cards/AlbertEinstein.jpg', 'I am currently wrapped up in my equations, I will get back to you at the speed of light.', 'aeinstein', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(2, 'Ching', NULL, 'Shih', '(403) 210-7833', 'ching.shih@travelexperts.com', 'Senior Agent', 2, 5,  '"Under the leadership of a man you have all chosen to flee. We shall see how you prove yourselves under the hand of woman."', 'Princess of the Chinese Seas', 'images/cards/ChingShih.jpg', 'I am currently engaged with a client, I will get back to you when I am finished.', 'cshih', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(3, 'Edward', 'B.', 'Teach', '(403) 210-7833', 'edward.teach@travelexperts.com', 'Senior Agent', 2, 5, '"Damnation seize my soul if I give you quarters, or take any from you"', 'Blackbeard', 'images/cards/EdwardTeach.jpg', 'I am out pillaging on the high seas, I will get back to you when I return. YYYAAAAARRRRR!', 'eteach', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(4, 'Genghis', NULL, 'Khan', '(403) 210-7833', 'genghis.khan@travelexperts.com', 'Intermediate Agent', 2, 4, '"I am the punishment of God...If you had not committed great sins, God would not have sent a punishment like me upon you."', 'The Great Khan', 'images/cards/GenghisKhan.jpg', 'I am currently destroying my enemies, I will get back to you when they are vanquished.', 'gkhan', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(5, 'Hayreddin', NULL, 'Barbarossa', '(403) 210-7833', 'hayreddin.barbarossa@travelexperts.com', 'Senior Agent', 2, 4, '"Whence on the seas horizon comes that roar?"', 'Redbeard', 'images/cards/HayreddinBarbarossa.jpg', 'I am currently on vacation at my home on the Isles of Lesbos, I will get back to you when I return to the office.', 'bbarbarossa', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(6, 'HoChi', NULL, 'Minh', '(403) 210-7833', 'hochi.minh@travelexperts.com', 'Junior Agent', 2, 1, '"Remember, the storm is a good opportunity for the pine and cypress to show their strength and their stability"', 'Communist Revolutionary', 'images/cards/HoChiMinh.jpg', 'I am currently freeing my citizens from oppression, I will get back to you when I have a chance.', 'hminh', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(7, 'Jane', 'M.', 'Goodall', '(403) 210-7833', 'jane.goodall@travelexperts.com', 'Junior Agent', 1, 2, '"The greatest danger to our future is apathy"', 'Pioneering Chimpanzee Researcher', 'images/cards/JaneGoodall.jpg', 'I am out playing with the chimpanzees, I will get back to you when I return.', 'jgoodall', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(8, 'Mahatma', 'K.', 'Gandhi', '(403) 210-7833', 'mahatma.gandhi@travelexperts.com', 'Junior Agent', 1, 1, '"Happiness is when what you think, what you say, and what you do are in harmony."', 'Father of India', 'images/cards/MahatmaGandhi.jpg', 'I am engaging in nonviolent protest, I will get back to you when I have a spare moment.', 'mgandhi', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(9, 'Marie', 'S.', 'Curie', '(403) 210-7833', 'marie.curie@travelexperts.com', 'Junior Agent', 1, 3, '"Be less curious about the people and more curious about the ideas"', 'Winner of two Nobel Prizes', 'images/cards/MarieCurie.jpg', 'I am in the lab, I will get back to you when my experiments are done.', 'mcurie', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(10, 'Neferneferuaten', NULL, 'Nefertiti', '(403) 210-7833', 'neferneferuaten.nefertiti@travelexperts.com', 'Intermediate Agent', 2, 3, '"You cannot change the desert. You can only take the fastest course through it. Wishing its an oasis wont make it so..."', 'The beautiful one has come', 'images/cards/NeferneferuatenNefertiti.jpg', 'I am out by the nile contemplating destiny, I will answer you upon my return.', 'nnefertiti', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(11, 'Pablo', NULL, 'Escobar', '(403) 210-7833', 'pablo.escobar@travelexperts.com', 'Senior Agent', 2, 3, '"Everyone has a price, the important thing is to find out what it is."', 'El Patrón', 'images/cards/PabloEscobar.jpg', 'I am out picking up a shipment, I will answer you when I have the goods.','pescobar', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(12, 'Robert', 'F.', 'Scott', '(403) 210-7833', 'robert.scott@travelexperts.com', 'Senior Agent', 1, 4, '"Hunger and fear are the only realities in dog life; an empty stomach makes a fierce dog."', 'Antarctic Explorer', 'images/cards/RobertFalconScott.jpg', 'I can imagine few things more trying to the patience than the long wasted days of waiting, which is why I will get back to you as soon as I can.', 'rscott', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(13, 'Sir David', 'F.', 'Attenborough', '(403) 210-7833', 'sirdavid.attenborough@travelexperts.com', 'Senior Agent', 1, 3, '"An understanding of the natural world and whats in it is a source of not only a great curiousity but great fulfillment."', 'The Voice of Planet Earth', 'images/cards/SirDavidAttenborough.jpg', 'I am exploring the beauty of our planet. I will reply when I am done appreciating it.', 'sattenborough', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(14, 'Steve', 'R.', 'Irwin', '(403) 210-7833', 'steve.irwin@travelexperts.com', 'Senior Agent', 2, 4, '"So fear helps me from making mistakes, but I make lot of mistakes."', 'The Crocodile Hunter', 'images/cards/SteveIrwin.jpg', 'Crikey, I am out wresting a big croc, I will get back to you when I have it under control.', 'sirwin', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm'),
(15, 'Wayne', 'D.', 'Gretzky', '(403) 210-7833', 'wayne.gretzky@travelexperts.com', 'Junior Agent', 2, 5, '"I skate to where the puck is going to be, not where it has been"', 'The Great One', 'images/cards/WayneGretzky.jpg', 'I am in my office, I will get back to you once I score.', 'wgretzky', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm');
...
(11, 168, '2016-03-17', '2016-04-01', 'Calgary/Vancouver/Calgary', 'Vancouver', '450', '22.5000', 11, 'NA', 'FST', 'BK', 23),
(15, 306, '2016-05-09', '2016-06-03', 'all-inclusive European tour', 'London, England', '3000', '112.5000', 15, 'EU', 'ECN', 'GR', 14),
(16, 306, '2016-05-09', '2016-06-03', 'all-inclusive European tour', 'London, England', '3000', '112.5000', 15, 'EU', 'ECN', 'GR', 14),
(17, 178, '2016-07-18', '2016-08-01', 'Calgary/Calcutta/Calgary', 'Calcutta, India', '799', '39.9500', 17, 'MEAST', 'FST', 'BK', 23),
(34, 142, '2016-05-08', '2016-06-02', 'Calgary/Athens/Calgary', 'Athens, Greece', '1000', '32.5000', 34, 'MED', 'ECN', 'BK', 12),
(46, 141, '2016-05-14', '2016-06-07', 'midsize car', 'Toronto', '900', '29.2500', 46, 'NA', 'NA', 'NC', 20),
(49, 201, '2016-05-12', '2016-05-31', 'Calgary/Victoria/Calgary', 'Victoria', '199', '2.2885', 49, 'NA', 'ECN', 'BK', 12),
(52, 225, '2016-05-14', '2016-06-07', ' ', 'Toronto', '1700', '55.2500', 52, 'NA', 'DLX', 'BK', 12),
(55, 771, '2016-05-14', '2016-06-07', 'Calgary/Toronto/Calgary', 'Toronto', '1200', '60', 55, 'NA', 'FST', 'BK', 23),
(57, 893, '2016-09-24', '2016-10-15', 'Calgary/London/Calgary', 'London, England', '750', '75', 57, 'EU', 'ECN', 'BK', 13),
(62, 964, '2017-01-09', '2017-01-19', 'Calgary/Victoria/Calgary', 'Victoria', '205', '10.2500', 62, 'NA', 'ECN', 'BK', 23),
(65, 204, '2017-01-31', '2017-02-13', 'Calgary/Cairo/Calgary', 'Cairo, Egypt', '350', '17.5000', 65, 'MEAST', 'FST', 'BK', 23),
(73, 220, '2017-03-13', '2017-03-18', 'Calgary/Grande Prairie/Calgary', 'Grande Prairie', '150', '7.5000', 73, 'NA', 'FST', 'BK', 23),
(79, 185, '2017-03-29', '2017-04-28', 'Calgary/Sydney/Calgary', 'Sydney, Australia', '2200', '264', 79, 'ANZ', 'ECN', 'BK', 30),
(80, 256, '2017-03-29', '2017-04-11', 'Calgary/Victoria/Calgary', 'Victoria', '190', '9.5000', 80, 'NA', 'ECN', 'BK', 23),
(84, 185, '2017-04-01', '2017-04-25', 'Australian trek', ' ', '6250', '234.3750', 84, 'ANZ', 'NA', 'BK', 15),
(85, 185, '2017-04-01', '2017-04-25', 'Australian trek', ' ', '6250', '234.3750', 84, 'ANZ', 'NA', 'BK', 15),
(89, 279, '2017-04-17', '2017-04-22', 'Calgary/Toronto/Calgary', 'Toronto', '628', '31.4000', 89, 'NA', 'FST', 'BK', 23),
(98, 230, '2017-05-05', '2017-05-10', 'Calgary/Vancouver/Calgary', 'Vancouver', '1048', '52.4000', 98, 'NA', 'FST', 'BK', 23),
(108, 193, '2017-05-19', '2017-06-01', 'Calgary/Athens/Calgary', 'Athens, Greece', '1200', '60', 108, 'MED', 'ECN', 'BK', 23),
(122, 300, '2017-05-23', '2017-06-07', 'Calgary/Victoria/Calgary', 'Victoria', '175', '8.7500', 124, 'NA', 'ECN', 'BK', 16),
(138, 397, '2017-07-12', '2017-07-16', 'Calgary/Montreal/Calgary', 'Montreal', '645', '32.2500', 138, 'NA', 'FST', 'BK', 23),
(141, 244, '2017-07-15', '2017-07-19', 'Calgary/Toronto/Calgary', 'Toronto', '499', '24.9500', 141, 'NA', 'FST', 'BK', 23),
(148, 805, '2017-07-25', '2017-08-11', 'Calgary/Athens/Calgary', 'Athens, Greece', '2300', '70', 148, 'MED', 'FST', 'BK', 23),
(152, 1134, '2017-09-29', '2017-10-12', 'Calgary/Montreal/Calgary', 'Montreal', '780', '39', 152, 'NA', 'FST', 'BK', 23),
(156, 139, '2017-11-07', '2017-11-12', 'Calgary/Toronto/Calgary', 'Toronto', '620', '31', 156, 'NA', 'BSN', 'BK', 23),
(161, 518, '2015-11-07', '2015-11-12', 'Calgary/London/Calgary', 'London, England', '620', '31', 161, 'EU', 'BSN', 'BK', 44),
(162, 218, '2017-11-12', '2017-11-18', 'Calgary/Toronto/Calgary', 'Toronto', '620', '31', 162, 'NA', 'BSN', 'BK', 23),
(172, 686, '2015-11-07', '2015-11-12', 'Calgary/London/Calgary', 'London, England', '629', '31.4500', 172, 'EU', 'FST', 'BK', 23),
(187, 449, '2015-02-15', '2015-02-20', 'Calgary/Houston/Calgary', 'Houston', '2875', '60', 187, 'NA', 'FST', 'BK', 23),
(199, 286, '1999-03-01', '1999-03-16', 'Calgary/Hong Kong/Calgary', 'Hong Kong, China', '3625', '70', 199, 'ASIA', 'FST', 'BK', 23),
(204, 933, '1999-03-04', '1999-03-09', 'Calgary/Toronto/Calgary', 'Toronto', '620', '31', 204, 'NA', 'FST', 'BK', 23),
(220, 932, '1999-02-21', '1999-02-26', 'Calgary/Houston/Calgary', 'Houston', '620', '31', 220, 'NA', 'FST', 'BK', 23),
(226, 460, '1999-10-03', '1999-10-08', 'Calgary/Montreal/Calgary', 'Montreal', '2585', '60', 226, 'NA', 'FST', 'BK', 23),
(228, 573, '1999-12-03', '1999-12-07', 'Ramada', 'Vancouver', '700', '8.0500', 228, 'NA', 'SNG', 'BK', 35),
(263, 255, '1999-05-01', '1999-06-01', 'Calgary/Sydney/Calgary', 'Sydney, Australia', '2500', '70', 263, 'ANZ', 'FST', 'BK', 23),
(265, 306, '1999-05-02', '1999-05-31', 'European golf package', 'Paris, France', '3000', '112.5000', 264, 'EU', 'NA', 'GR', 36),
(266, 1076, '1999-05-02', '1999-05-31', 'Calgary/Paris/Calgary', 'Paris, France', '3000', '70', 266, 'EU', 'ECN', 'BK', 23),
(270, 331, '1999-05-01', '1999-05-29', 'Calgary/London/Calgary', 'London, England', '800', '40', 273, 'EU', 'ECN', 'BK', 23),
(273, 776, '1999-05-01', '1999-05-29', 'Calgary/London/Calgary', 'London, England', '800', '40', 273, 'EU', 'ECN', 'BK', 23),
(275, 255, '1999-05-06', '1999-05-29', 'Australian trek', ' ', '7900', '296.2500', 263, 'ANZ', 'NA', 'BK', 15),
(276, 1132, '1999-05-01', '1999-05-29', 'Calgary/London/Calgary', 'London, England', '800', '40', 273, 'EU', 'ECN', 'BK', 23),
(287, 980, '1999-05-29', '1999-06-03', 'Calgary/Rio de Janeiro/Calgary', 'Rio de Janeiro, Brazil', '3590', '70', 287, 'SA', 'FST', 'BK', 23),
(305, 979, '1999-06-05', '1999-06-10', 'Calgary/Toronto/Calgary', 'Toronto', '2580', '60', 305, 'NA', 'FST', 'BK', 23),
(312, 398, '1999-06-12', '1999-06-17', 'Calgary/Montreal/Calgary', 'Montreal', '615', '30.7500', 312, 'NA', 'FST', 'BK', 23),
(313, 775, '1999-06-12', '1999-06-17', 'Calgary/Montreal/Calgary', 'Montreal', '2258', '60', 313, 'NA', 'FST', 'BK', 23),
(322, 404, '1999-07-11', '1999-07-18', 'Calgary/Toronto/Calgary', 'Toronto', '630', '31.5000', 322, 'NA', 'FST', 'BK', 23),
(325, 874, '1999-07-17', '1999-08-02', 'Calgary/Montreal/Calgary', 'Montreal', '630', '31.5000', 325, 'NA', 'FST', 'BK', 23),
(327, 228, '1999-07-25', '1999-08-10', 'Calgary/London/Calgary', 'London, England', '900', '45', 98, 'EU', 'ECN', 'BK', 23),
(369, 481, '1999-10-01', '1999-10-06', 'intermediate car', 'Paris, France', '500', '15.5000', 369, 'EU', 'NA', 'BK', 32),
(375, 492, '1999-10-01', '1999-10-06', 'Hilton', 'Paris, France', '650', '7.4750', 375, 'EU', 'DLX', 'BK', 31),
(381, 610, '1999-10-01', '1999-10-06', 'Calgary/Paris/Calgary', 'Paris, France', '3560', '70', 381, 'EU', 'FST', 'BK', 23),
(382, 619, '1999-10-07', '1999-10-12', 'Hilton', 'London, England', '620', '7.1300', 382, 'EU', 'DLX', 'BK', 31),
(384, 644, '1999-10-07', '1999-10-12', 'Calgary/London/Calgary', 'London, England', '600', '30', 384, 'EU', 'ECN', 'BK', 44),
(409, 492, '1999-10-22', '1999-11-03', 'Medium size car', 'Greece', '500', '15.5000', 409, 'MED', 'NA', 'NC', 55),
(410, 624, '1999-10-21', '1999-11-04', 'Calgary-Athens-Calgary', 'Greece', '1300', '65', 410, 'MED', 'ECN', 'BK', 7),
(424, 492, '1999-10-27', '1999-10-30', 'cruise on the Greek\'s islands', 'Greece', '650', '19.5000', 425, 'MED', 'INT', 'NC', 49),
(425, 492, '1999-10-27', '1999-10-30', 'cruise on the Greek\'s islands', 'Greece', '650', '19.5000', 425, 'MED', 'INT', 'NC', 49),
(442, 654, '1999-11-04', '1999-11-09', 'Calgary/London/Calgary', 'London, England', '629', '31.4500', 442, 'EU', 'ECN', 'BK', 23),
(443, 691, '1999-11-05', '1999-11-10', 'Calgary/Paris/Calgary', 'Paris, France', '4599', '70', 443, 'EU', 'FST', 'BK', 23),
(449, 645, '1999-11-06', '1999-11-11', 'Calgary/Toronto/Calgary', 'Toronto', '599', '29.9500', 449, 'NA', 'ECN', 'BK', 44),
(458, 323, '1999-12-08', '1999-12-12', 'Calgary/Edmonton/Calgary', 'Edmonton', '300', '15', 517, 'NA', 'BSN', 'BK', 44),
(482, 740, '1999-11-17', '1999-11-23', 'Hilton', 'Sydney, Australia', '590', '6.7850', 482, 'ANZ', 'DLX', 'BK', 31),
(484, 549, '1999-11-14', '1999-11-19', 'Calgary/Toronto/Calgary', 'Toronto', '600', '30', 484, 'NA', 'ECN', 'BK', 23),
(488, 601, '1999-11-14', '1999-11-19', 'Niagara on the Lake', 'Niagara', '675', '7.7625', 488, 'NA', 'DLX', 'BK', 33),
(489, 1040, '1999-11-17', '1999-11-23', 'Calgary/Sydney/Calgary', 'Sydney, Australia', '625', '31.2500', 489, 'ANZ', 'FST', 'BK', 23),
(510, 587, '1999-12-02', '1999-12-06', 'Ramada', 'Toronto', '650', '7.4750', 510, 'NA', 'SNG', 'BK', 35),
(511, 745, '1999-11-16', '1999-11-22', 'Niagara on the Lake', 'Niagara', '620', '7.1300', 511, 'NA', 'DLX', 'BK', 33),
(512, 903, '1999-11-16', '1999-11-22', 'Calgary/Toronto/Calgary', 'Toronto', '499', '24.9500', 512, 'NA', 'ECN', 'BK', 23),
(517, 695, '1999-12-02', '1999-12-06', 'Calgary/Toronto/Calgary', 'Toronto', '700', '35', 517, 'NA', 'FST', 'BK', 44),
(529, 479, '1999-12-12', '1999-12-19', 'Calgary/Vancouver/Calgary', 'Vancouver', '350', '17.5000', 529, 'NA', 'BSN', 'BK', 44),
(546, 482, '2000-01-10', '2000-01-15', 'Calgary/Montreal/Calgary', 'Montreal', '800', '40', 546, 'NA', 'BSN', 'BK', 44),
(553, 233, '2000-01-13', '2000-01-18', 'Calgary/Montreal/Calgary', 'Montreal', '750', '37.5000', 553, 'NA', 'BSN', 'BK', 44),
(594, 497, '2000-01-20', '2000-01-25', 'Calgary/Toronto/Calgary', 'Toronto', '650', '32.5000', 594, 'NA', 'BSN', 'BK', 44),
(596, 343, '2000-02-06', '2000-02-10', 'Calgary/London/Calgary', 'London, England', '850', '42.5000', 596, 'EU', 'BSN', 'BK', 44),
(598, 401, '2000-02-06', '2000-02-10', 'Calgary/London/Calgary', 'London, England', '850', '42.5000', 598, 'EU', 'BSN', 'BK', 44),
(600, 642, '2000-02-06', '2000-02-10', 'cancellation/medical policy # 97543', ' ', '200', '4', 600, 'EU', 'NA', 'NC', 39),
(604, 651, '2000-02-06', '2000-02-11', 'Calgary/Toronto/Calgary', 'Toronto', '700', '35', 604, 'NA', 'FST', 'BK', 44),
(605, 780, '2000-02-08', '2000-02-12', 'Calgary/Toronto/Calgary', 'Toronto', '700', '35', 605, 'NA', 'FST', 'BK', 44),
(609, 588, '2000-01-30', '2000-02-10', ' ', 'Hong Kong, China', '900', '10.3500', 609, 'ASIA', 'DLX', 'BK', 41),
(613, 629, '2000-01-30', '2000-02-10', 'Calgary/Hong Kong/Calgary', 'Hong Kong, China', '5200', '260', 613, 'ASIA', 'FST', 'BK', 44),
(614, 629, '2000-01-30', '2000-02-10', 'cancellation/medical policy # 98123', ' ', '250', '5', 614, 'ASIA', 'NA', 'NC', 39),
(618, 790, '2000-02-06', '2000-02-10', 'Calgary/Toronto/Calgary', 'Toronto', '700', '35', 618, 'NA', 'FST', 'BK', 44),
(622, 863, '2000-02-06', '2000-02-10', 'Radisson', 'London, England', '990', '11.3850', 622, 'EU', 'DLX', 'BK', 37),
(631, 172, '2000-02-05', '2000-02-09', 'Calgary/Toronto/Calgary', 'Toronto', '750', '37.5000', 631, 'NA', 'BSN', 'BK', 44),
(665, 502, '2000-02-29', '2000-03-03', 'Calgary/Rio de Janeiro/Calgary', 'Rio de Janeiro, Brazil', '1130', '56.5000', 665, 'SA', 'BSN', 'BK', 44),
(902, 751, '2000-04-25', '2000-05-16', 'Calgary-Auckland flight', 'NZ', '3000', '150', 902, 'ANZ', 'BSN', 'BK', 19),
(910, 150, '2000-05-16', '2000-05-25', 'Calgary/London/Calgary', 'London, England', '900', '45', 910, 'EU', 'BSN', 'BK', 44),
(940, 1131, '2000-05-05', '2000-06-02', 'Calgary/Toronto/Montreal tour', 'Canada', '2600', '97.5000', 939, 'NA', 'FST', 'BK', 67),
(943, 821, '2000-05-06', '2000-06-03', 'Tahiti - South Seas', ' ', '8562', '256.8600', 943, 'SP', 'INT', 'NC', 70),
(955, 141, '2000-05-13', '2000-05-22', 'Calgary/Paris/Calgary', 'Paris, France', '950', '47.5000', 973, 'EU', 'BSN', 'BK', 44),
(960, 186, '2000-05-14', '2000-05-23', 'Calgary/Toronto/Calgary', 'Toronto', '650', '32.5000', 960, 'NA', 'BSN', 'BK', 44),
(967, 392, '2000-05-13', '2000-05-22', 'World Access', 'Paris, France', '1200', '39', 973, 'EU', 'DLX', 'BK', 60),
(972, 812, '2000-05-13', '2000-05-22', 'midsize car', 'Paris, France', '850', '26.3500', 973, 'EU', 'NA', 'NC', 61),
(973, 812, '2000-05-13', '2000-05-22', 'cancellation policy # 4987140', ' ', '300', '6', 973, 'EU', 'NA', 'NC', 47),
(988, 301, '2000-05-19', '2000-06-19', 'cancellation/medical policy #923665', 'Peru, argentina, Bollivi', '345', '6.9000', 988, 'SA', 'NA', 'NC', 50),
(990, 757, '2000-05-19', '2000-06-19', 'Peru, Argentina, Bolivia tour', ' ', '3980', '149.2500', 989, 'SA', 'NA', 'BK', 28),
(1002, 846, '2000-05-22', '2000-05-29', 'Alaska', ' ', '2531', '75.9300', 1001, 'NA', 'INT', 'NC', 68),
(1024, 346, '2000-06-01', '2000-06-16', 'Asia-Africa-Mediteranean', ' ', '12630', '378.9000', 1075, 'MED', 'ECN', 'NC', 70),
(1034, 716, '2000-06-03', '2000-06-28', 'Calgary-Vancouver flight', 'canada', '139', '6.9500', 1034, 'NA', 'FST', 'BK', 19),
(1067, 720, '2000-06-06', '2000-07-01', 'Calgary-toronto-montreal flight', 'Canada', '1000', '50', 1067, 'NA', 'FST', 'BK', 64),
(1073, 761, '2000-06-06', '2000-07-01', 'Toronto-Montreal-ottawa tour', 'Canada', '3080', '115.5000', 1073, 'NA', 'NA', 'BK', 48),
(1089, 827, '2000-05-30', '2000-06-07', 'Alaska plus air', ' ', '3652', '109.5600', 1089, 'NA', 'INT', 'NC', 75),
(1105, 831, '2000-05-30', '2000-06-14', 'Ryndam - Time Travel', ' ', '5506', '165.1800', 1105, 'SA', 'OCNV', 'NC', 70),
(1141, 816, '2000-05-20', '2000-05-20', 'Royal Ontario Museum', 'Canada', '25', '0', 1141, 'NA', 'NA', 'NC', 79),
(1165, 355, '2000-07-08', '2000-07-16', 'Calgary/London/Calgary', 'London, England', '850', '42.5000', 1165, 'EU', 'BSN', 'BK', 44),
'$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 7),
(139, 'Angelo', 'Garshman', '82 Western Ave., NE', 'Calgary', 'AB', 'T3E 5C8', 'Canada', '4032259966', '4032696541', 'agarshman@space.ca', 'agarshman', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 3),
(140, 'Derrick', 'Baltazar', '9111 Church Ave. #3N, NE', 'Calgary', 'AB', 'T3E 5C9', 'Canada', '4032255231', '4037502547', 'dbaltazar@msn.com', 'dbaltazar', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 6),
(141, 'Robert', 'Boyd', '96-04 57th Ave #12A, NE', 'Calgary', 'AB', 'T3E 5C5', 'Canada', '4032255647', '4037509512', 'rboyd@yahoo.com', 'rboyd', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 3),
(142, 'Monica', 'Waldman', '257 Depot Rd., NE', 'Calgary', 'AB', 'T2J 6P3', 'Canada', '4032255629', '4032844566', 'mwaldman@aol.com', 'mWaldman', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 2),
(143, 'Gerard', 'Biers', '205 19th St., NE', 'Calgary', 'AB', 'T2J 6B6', 'Canada', '4032251952', '4037506578', 'gbiers@brewery.bud', 'gbiers', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 8),
(144, 'z', 'z', 'z', 'z', 'Z', 'Z1Z1Z1', 'z', '5555555555', '2222222222', 'z@z.zz', 'zz', '$2y$10$qFAv/LKft6hr/6a7b1Rt.O6CAMeVTKzMm9QHtR4BlBOUvLrT1JvTm', 1);
...
('BK', 'Booking Charge', '25', NULL),
('CH', 'Change', '15', NULL),
('GR', 'Group Booking', '100', NULL),
('NC', 'No Charge', '0', NULL),
('NSF', 'Insufficient Funds', '25', NULL),
('RF', 'Refund', '25', NULL),
('RS', 'Research', '50', NULL);
...
CREATE TABLE `packages` (
  ...
  `PkgDesc` varchar(255) DEFAULT NULL,
...
INSERT INTO `packages` (`PackageId`, `PkgName`, `Image`, `Partner`, `AirfairInclusion`, `PkgStartDate`, `PkgEndDate`, `PkgDesc`, `Duration`, `PkgBasePrice`, `PkgAgencyCommission`) VALUES
(1, 'Whales and Bears of British Columbia', 'images/Package_Pics/Whales and Bears of BC.jpg', 'https://www.tourradar.com/t/88750#p=2_', 1, '2019-09-18', '2019-09-27', 'Start and end in Vancouver! A 10 day tour package taking you through Vancouver, Canada and 7 other destinations in Canada.', '10 days', '4999', '400'),
(2, 'Canadian Rockies 2019', 'images/Package_Pics/Canadian Rockies.jpg', 'https://www.tourradar.com/t/106388#p=4_', 1, '2019-08-19', '2019-08-28', 'Start and end in Vancouver! A 10 day tour package taking you through Vancouver, Canada and 8 other destinations in Canada.', '10 days', '2609', '310'),
(3, 'Orlando and the theme parks', 'images/Package_Pics/Orland Disney World.jpg', 'https://www.tourradar.com/t/159833#p=2_', 1, '2019-05-14', '2019-05-19', 'Start and end in Orlando! A 4 day tour package taking you through the theme parks in Orlando, USA.', '4 days', '456', '300'),
(4, 'Northern California', 'images/Package_Pics/sanFrancisco.jpg', 'https://www.tourradar.com/t/82345#p=5_', 1, '2020-06-06', '2020-06-13', 'Start and end in San Francisco! An 8 day tour package taking you through San Francisco, USA and 9 other destinations.', '8 days', '3219', '$280'),
(5, 'Vegas to Grand Canyon', 'images/Package_Pics/Las Vegas.jpg', 'https://www.tourradar.com/t/148301#p=15_', 1, '2019-11-24', '2019-11-27', 'Start and end in Las Vegas! A 4 day tour package taking you through Las Vegas, USA with excursions to the Hoover Dam and Grand Canyon.', '4 days', '475', '280'),
(6, 'South America Express', 'images/Package_Pics/South America Express.jpg', 'https://www.tourradar.com/t/72784#p=5_', 1, '2019-08-02', '2019-08-27', 'Start in Lima and end in Rio de Janeiro! A 26 day tour package taking you from Lima to Rio de Janeiro and 16 other destinations in Latin America.', '26 days', '5102', '280'),
(7, 'Wonders of Brazil', 'images/Package_Pics/Brazil.jpg', 'https://www.tourradar.com/t/10459#p=2_', 1, '2020-01-10', '2020-01-24', 'Start and end in Rio de Janeiro! A 15 day tour package taking you through Rio de Janeiro, Brazil and 4 other destinations in Latin America.', '15 days', '2602', '280'),
(8, 'Europe Explore', 'images/Package_Pics/Europe Explore.jpg', 'https://www.tourradar.com/t/43444#p=1_', 1, '2019-07-30', '2019-08-16', 'Start and end in London! An 18 day tour package taking you through London, England and 15 other destinations in Europe.', '18 days', '3250', '280'),
(9, 'Great Britain & Ireland', 'images/Package_Pics/Ireland.jpg', 'https://www.tourradar.com/t/104781#p=8_', 1, '2019-10-03', '2019-10-19', 'Start and end in London! A 17 day tour package taking you through London, England and 21 other destinations in Europe.', '17 days', '3856', '280'),
(10, 'Scandinavia including Iceland', 'images/Package_Pics/Iceland.jpg', 'https://www.tourradar.com/t/129323#p=5_', 1, '2020-05-04', '2020-05-22', 'Start in Copenhagen and end in Reykjavik! A 19 day tour package taking you through Copenhagen, Denmark and 19 other destinations in Europe.', '19 days', '6778', '280'),
(11, 'Mediterranean Antiquities', 'images/Package_Pics/Mediterranean.jpg', 'https://www.tourradar.com/t/168943#p=8_', 1, '2021-03-02', '2021-03-16', 'Start in Athens and end in Barcelona! A 15 day tour package taking you through Athens, Greece and 9 other destinations in Europe.', '15 days', '6778', '280'),
(12, 'The Best of Eastern Europe', 'images/Package_Pics/Eastern Europe.jpg', 'https://www.tourradar.com/t/51289#p=11_', 1, '2020-05-11', '2020-05-24', 'Start and end in Berlin! A 14 day tour package taking you through Berlin, Germany and 11 other destinations in Europe.', '14 days', '1895', '280'),
(13, 'Moscow to St Petersburg ', 'images/Package_Pics/Moscow.jpg', 'https://www.tourradar.com/t/33248#p=1_', 1, '2020-02-15', '2020-02-22', 'Start in Moscow and end in St Petersburg! A 8 day tour package taking you from Moscow to St Petersburg and through Moscow, Russia and 3 other destinations in Russia.', '8 days', '1895', '280'),
(14, 'Turkey – Hike, Bike & Kayak', 'images/Package_Pics/Turkey.jpg', 'https://www.tourradar.com/t/4449#p=13_', 1, '2020-04-13', '2020-04-24', 'Start and end in Istanbul! A 12 day tour package taking you through Istanbul, Turkey and 5 other destinations in Turkey.', '12 days', '5695', '280'),
(15, 'Pyramids, Petra, Promised Land', 'images/Package_Pics/Egypt.jpg', 'https://www.tourradar.com/t/8348#p=1_', 1, '2019-08-09', '2019-08-27', 'Start in Cairo and end in Jerusalem! A 19 day tour package taking you from Cairo to Jerusalem and through Cairo, Egypt and 16 other destinations.', '19 days', '5695', '280'),
(16, 'Great Wall and Pandas', 'images/Package_Pics/China.jpg', 'https://www.tourradar.com/t/71835#p=6_', 1, '2019-11-02', '2019-11-15', 'Start in Beijing and end in Shanghai! A 14 day tour package taking you from Beijing to Shanghai and through Beijing, China and 5 other destinations in China.', '14 days', '4895', '280'),
(17, 'Epic Japan', 'images/Package_Pics/japan.jpg', 'https://www.tourradar.com/t/83489#p=5_', 1, '2019-11-30', '2019-12-10', 'Start in Tokyo and end in Osaka! An 11 day tour package taking you from Tokyo to Osaka and through Tokyo, Japan and 4 other destinations in Japan.', '11 days', '2651', '280'),
(18, 'Thai Indochina Grand Tour', 'images/Package_Pics/Thailand.jpg', 'https://www.tourradar.com/t/33205#p=12_', 1, '2019-10-28', '2019-11-24', 'Start in Bangkok and end in Siem Reap! A 28 day tour package taking you from Bangkok to Siem Reap and through Bangkok, Thailand and 22 other destinations in Asia.', '28 days', '4575', '280'),
(19, 'India Golden Triangle Tour', 'images/Package_Pics/India.jpg', 'https://www.tourradar.com/t/125427', 1, '2020-11-01', '2020-11-16', 'Start and end in New Delhi! A 16 day tour package taking you through New Delhi, India and 12 other destinations in India.', '16 days', '2355', '280'),
(20, 'Essential Morocco', 'images/Package_Pics/Morocco.jpg', 'https://www.tourradar.com/t/16559#p=4_', 1, '2019-11-01', '2019-11-14', 'Start in Casablanca and end in Marrakesh! An 11 day tour package taking you from Casablanca to Marrakesh and through Casablanca, Morocco and 9 other destinations in Morocco.', '11 days', '3548', '280'),
(21, 'South Africa: From the Cape to Kruger', 'images/Package_Pics/South Africa.jpg', 'https://www.tourradar.com/t/100309#p=1_', 1, '2019-11-03', '2019-11-16', 'Start in Cape Town and end in Johannesburg! A 14 day tour package taking you through Cape Town and 18 other destinations in South Africa.', '14 days', '3548', '280'),
(22, 'Uganda Wildlife Safari', 'images/Package_Pics/Uganda.jpg', 'https://www.tourradar.com/t/164408#p=13_', 1, '2020-04-19', '2020-05-02', 'Start and end in Entebbe! A 14 day tour package taking you through Entebbe, Uganda and 8 other destinations in Uganda.', '14 days', '5674', '280'),
(23, 'Aussie Adventure including Fiji', 'images/Package_Pics/Australia.jpg', 'https://www.tourradar.com/t/84654#', 1, '2020-02-01', '2020-02-21', 'Start in Cairns and end in Nadi! A 21 day tour package taking you from Cairns to Nadi and through Cairns, Australia and 10 other destinations in Australia/Oceania.', '21 days', '6824', '280'),
(24, 'New Zealand Encompassed', 'images/Package_Pics/New Zealand.jpg', 'https://www.tourradar.com/t/46441#p=13_', 1, '2020-10-21', '2020-11-13', 'Start in Auckland and end in Wellington! A 24 day tour package taking you from Auckland to Wellington and through Auckland, New Zealand and 15 other destinations in New Zealand.', '24 days', '3395', '280'),
(25, "Antarctic Peninsula from Buenos Aires", 'images/Package_Pics/Antarctica.jpg', 'https://www.tourradar.com/t/85049#p=6_', 1, '2019-11-14', '2019-12-03', 'Start and end in Buenos Aires! A 20 day tour package taking you through Buenos Aires, Argentina and 12 other destinations in Latin America.', '20 days', '17935', '280');
